...
# Customize Cluster Sidebar

The Cluster Details page in the AppsCode Dashboard features a dedicated sidebar that displays standard Kubernetes workloads and various AppsCode custom resources by default. This sidebar provides quick access to resource details pages and related features. However, AppsCode recognizes the importance of customization to tailor the user experience.

## Accessing Cluster Sidebar Settings

To access the Cluster Sidebar Settings page and customize your sidebar preferences, follow these steps:

1. **Navigate to Cluster Settings:**
   - From the [AppsCode Dashboard](https://console.appscode.com), click on your imported cluster to go to the Cluster Overview page.
   - Click on the ⚙️ (Gear) icon in the navbar to access the Cluster Settings page.

2. **Visit Sidebar Tab:**
   - In the Cluster Settings page, navigate to the `Sidebar` tab.

## Cluster Sidebar Settings Page
