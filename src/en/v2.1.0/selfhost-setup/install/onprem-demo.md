...
### 6. TLS
Configure TLS certificates for secure communication. You can choose the Issuer type and provide the corresponding certificates and keys.
...
* You can enable either the **Gateway API** or standard **Ingress**. 
